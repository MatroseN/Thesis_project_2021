...
class Model_66:
    def __init__(self, random_seed, serial, seed_serial):
        ...
        self.description = "Activation/TanH"
        self.serial = serial
        self.ss = seed_serial
        ...
        self.model.add(Conv2D(filters=6, kernel_size=(3, 3), activation=activations.tanh, input_shape=(32, 32, 3)))
        self.model.add(AvgPool2D())
        self.model.add(Conv2D(filters=16, kernel_size=(3, 3), activation=activations.tanh))
        self.model.add(AvgPool2D())
        self.model.add(Flatten())
        self.model.add(Dense(units=120, activation=activations.tanh))
        self.model.add(Dense(units=84, activation=activations.tanh))
